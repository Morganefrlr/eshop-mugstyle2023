    ...
    return (
        <div className='bg-[#1D1F2D] flex w-[40vw] h-[100vh] flex-col max-md:w-[70vw]'>
            ...
            {featuredProducts.map(item =>
                <div className='flex w-[70%] h-auto mx-auto items-center text-zinc-100 mt-10 justify-between max-xl:w-[75%]'>
                    <div className='flex'>
                    ...
                    <div className='w-16 h-12 border-[1px] border-zinc-700 flex justify-center items-center max-lg:w-12 max-lg:h-8'>2</div>
                </div>
            )}
